  ...
  return (
    <div className="Home">
      ...
      <div className="chart-grid">
        ...
        <div className="chart-cell half">
          <h3>Glp Price / Supply</h3>
          { loading && <RiLoader5Fill size="3em" className="loader" /> }
          <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
            <ComposedChart syncId="syncId" data={addLiquiditiesChartData}>
              <CartesianGrid strokeDasharray="10 10" />
              <XAxis dataKey="timestamp" tickFormatter={tooltipLabelFormatter} minTickGap={30} />
              <YAxis dataKey="glpSupply" unit={dynamicUnit} tickFormatter={yaxisFormatter} width={YAXIS_WIDTH} />
              ...
              <Bar type="monotone" unit={dynamicUnit} dataKey="glpSupply" stackId="a" name="GLP Supply" fill="#8884ff" />
            </ComposedChart>
          </ResponsiveContainer>
        </div>
      </div>

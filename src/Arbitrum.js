      ...
      <div className="chart-grid">
          ...
          >
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpPerformanceData} syncId="syncGlp">
                ...
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={1} yAxisId="right" dot={false} dataKey="glpPrice" name="Glp Price" stroke={"#1B65A6"} strokeWidth={1} />
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={1} yAxisId="right" dot={false} dataKey="glpPlusFees" name="Glp w/ fees" stroke={"#50ABBF"} strokeWidth={1} />
        ...
        <div className="chart-cell">
           <GenericChart
              ...
              tooltipFormatter={tooltipFormatterNumber}
              tooltipLabelFormatter={tooltipLabelFormatterUnits}
              items={[{ key: 'actionSwapCount', name: 'Swaps', color: COLORS[0] }, { key: 'actionMarginCount', name: 'Margin trading', color: COLORS[4] }, { key: 'actionMintBurnCount', name: 'Mint & Burn GLP', color: "#FF8D00" }]}
              type="Composed"
            />
        </div>
        <div className="chart-cell">
